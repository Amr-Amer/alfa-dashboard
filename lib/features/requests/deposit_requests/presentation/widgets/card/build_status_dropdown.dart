...
class BuildDepositStatusDropdown extends StatelessWidget {
  final TransactionModel transaction;
  const BuildDepositStatusDropdown({super.key, required this.transaction});
        ...
        child: DropdownButton<String>(
          ...
          onChanged: (newStatus) async {
            if (newStatus != null && newStatus != currentStatus) {
              ...
              context.read<DepositsCubit>().changeDepositStatus(
                transaction,
                newStatus,
