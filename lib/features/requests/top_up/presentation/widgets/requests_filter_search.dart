...
import 'package:alfa_dashboard/features/requests/top_up/presentation/widgets/request_search_widget.dart';
import 'package:alfa_dashboard/utils/app_strings.dart';
import 'package:alfa_dashboard/utils/constants.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class RequestsFilterSearch extends StatelessWidget {
  const RequestsFilterSearch({super.key});
          ...
          child: Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                value: context.read<RequestsCubit>().selectedStatus,
                hint: const Text(
                  AppStrings.status,
                ...
                onChanged: (value) {
                  if (value != null) {
                    context.read<RequestsCubit>().filterByStatus(value);
                  }
                },
              ),
            ),
