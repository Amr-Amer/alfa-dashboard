...
import 'package:alfa_dashboard/features/requests/withdraw_requests/presentation/widgets/withdraw_search_widget.dart';
import 'package:alfa_dashboard/utils/app_strings.dart';
import 'package:alfa_dashboard/utils/constants.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class WithdrawsSearchFilter extends StatelessWidget {
  const WithdrawsSearchFilter({super.key});
          ...
          child: Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                value: context.read<WithdrawsCubit>().selectedStatus,
                hint: const Text(
                  AppStrings.status,
                ...
                onChanged: (value) {
                  if (value != null) {
                    context.read<WithdrawsCubit>().filterByStatus(value);
                  }
                },
              ),
            ),
