...
class WithdrawsSearchWidget extends StatelessWidget {
  const WithdrawsSearchWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<WithdrawsCubit, WithdrawsState>(
      ...
      child: Container(
        ...
        child: TextField(
          ...
          onChanged: (query) {
            context.read<WithdrawsCubit>().searchWithdrawRequests(query);
          },
        ),
      ),
    );
