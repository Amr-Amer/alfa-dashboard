      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildDetailItem('${AppStrings.createdAt} :', GlobalFun.formatDate(user.createdAt?? DateTime.now())),
            _buildDetailItem('${AppStrings.updatedAt} :', GlobalFun.formatDate(user.updatedAt?? DateTime.now())),
            _buildDetailItem('${AppStrings.hasFcmToken} : ', user.fcmToken.isNotEmpty ? AppStrings.yes : AppStrings.no),
          ],
        ),
      ),
      actions: [
